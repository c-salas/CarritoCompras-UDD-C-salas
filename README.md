...
```
cd existing_repo
git remote add origin https://gitlab.com/gunterlab/carritocompras-udd-c-salas.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/gunterlab/carritocompras-udd-c-salas/-/settings/integrations)
